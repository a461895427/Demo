!function (t, e) {
    ...
    function Ya(t) {
        ...
        return o(m) ? T = w = {
            ...
            if (!p) {
                ...
                for (p = v[d] = [], i = y ? Math.min(f, d) * T - .5 : m % f, n = y ? d * w / f - .5 : m / f | 0, l = j, u = h = 0; u < d; u++) a = u % f - i, s = n - (u / f | 0), p[u] = o = b ? Math.abs("y" === b ? s : a) : G(a * a + s * s), h < o && (h = o), o < l && (l = o);
    ...
    var R, I, i, n, a, h, l, f, d, c, m, g, y, b, T, w, x, k, C, A, S, D, z, F, E, B,
        ...
        L = {duration: .5, overwrite: !1, delay: 0}, j = 1e8, X = 1 / j, U = 2 * Math.PI, V = U / 4, J = 0,
        G = Math.sqrt, Z = Math.cos, K = Math.sin,
    ...
    function Xb(t, r, e, i) {
        ...
        if (~t.indexOf("%")) for (n in r) a = e[n] || (e[n] = []), "ease" === n || a.push({
            t: parseFloat(t),
            v: r[n],
            e: s
        }); else if (a = e[t] || (e[t] = []), W(r)) r.forEach(function (t, e) {
            return a.push({t: e / (r.length - 1) * 100, v: t, e: s})
        }); else for (n in r) "ease" === n || a.push({t: parseFloat(n), v: r[n], e: s})
    }
    ...
    var Qt, Yt = function _addPropTween(t, e, r, i, n, a, s, u, h) {
        ...
        if (!B || C && v || (v = "none"), e._ease = Rt(v, L.ease), e._yEase = k ? Bt(Rt(!0 === k ? v : k, L.ease)) : 0, k && e._yoyo && !e._repeat && (k = e._yEase, e._yEase = e._ease, e._ease = k), e._from = !B && !!g.runBackwards, !B || C && !g.stagger) {
            if (c = (l = D[0] ? _(D[0]).harness : 0) && g[l.prop], i = na(g, ut), S && S.render(-1, !0).kill(), y) if (sa(e._startAt = Jt.set(D, ja({
                data: "isStart",
                overwrite: !1,
                parent: z,
                immediateRender: !0,
                ...
                stagger: 0,
                parent: z
            }, i), c && (a[l.prop] = c), sa(e._startAt = Jt.set(D, a)), r < 0 && e._startAt.render(-1, !0), b) {
                if (!r) return
    ...
    var Jt = function (F) {
        function Tween(e, r, i, n) {
            ...
            var o, u, h, l, f, d, p, c, _ = (a = F.call(this, n ? r : oa(r)) || this).vars, m = _.duration, g = _.delay,
                ...
                M = _.scrollTrigger, k = _.yoyoEase, C = r.parent || I,
    ...
    Jt.version = Nt.version = oe.version = "3.8.1", l = 1, u() && Dt();
