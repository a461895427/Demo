!function (e, t) {
    ...
    function A(e) {
        if (!(e = v(e)[0])) return 0;
        var n, i, o, a, f, w, d, l = e.tagName.toLowerCase(), h = e.style, u = 1, c = 1;
    ...
    function B(e, t) {
        ...
        t = t || A(e) + 1;
        var i = d.getComputedStyle(e), r = i.strokeDasharray || "", o = n(i.strokeDashoffset), s = r.indexOf(",");
    ...
    var a, v, d, l, h, b = /[-+=\.]*\d+[\.e\-\+]*\d*[e\-\+]*\d*/gi,
        ...
        f = "DrawSVGPlugin", u = w(103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109), c = function (e) {
            ...
            version: "3.8.0", name: "drawSVG", register: function register(e) {
                a = e, C()
                ...
                var n, i, r, o, s = t._pt, a = t._style;
                if (s) {
